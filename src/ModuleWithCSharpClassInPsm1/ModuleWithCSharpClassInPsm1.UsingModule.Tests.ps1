using module .\ModuleWithCSharpClassInPsm1.psm1
...
Describe 'Module' {
	...
	It 'Should allow using the class type explicitly' {
		$instance = [MyNamespace.MyCSharpClassInPsm1]::new()
		$instance | Should -Not -Be $null
	}
	...
	It 'Should allow using the class type explicitly as a function parameter' {
		$explicitInstance = [MyNamespace.MyCSharpClassInPsm1]::new()
	...
	It 'Should allow using the enum type explicitly' {
		$enumValue = [MyNamespace.MyCSharpEnumInPsm1]::One
		$enumValue | Should -Be 'One'
	}

	It 'Should allow using the full enum type as a function parameter' {
		$enumValue = Get-MyCSharpEnumInPsm1WithParameter -enumValue ([MyNamespace.MyCSharpEnumInPsm1]::One)
		$enumValue | Should -Be 'One'
	}
